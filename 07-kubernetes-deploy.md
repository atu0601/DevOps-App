...
minikube image load devops-app-app

# Avec kind : charger l'image dans le cluster
kind load docker-image devops-app-app --name devops-training
# si cluster pas encore crée : kind create cluster --name devops-training
...
```bash
# Pods
# Ou kubectl get pods -n devops-training
kubectl get pods -w
...
kubectl set image deployment/devops-app app=devops-app-app
